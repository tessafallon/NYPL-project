...
# HocrLayer.create([{:filename => "5057783u"}, {:filename => "5057784u"}, {:filename => "5057785u"}])




###modify hocr file to have image in background
 #<link rel="stylesheet" type="text/css" href="../assets/claims.css"></link>
 #<img src="../5057783u.png"></img>